# Dolphin MMJR - A GameCube and Wii Emulator
...
Dolphin MMJR is an emulator for running GameCube and Wii games on Android, focused on perfomance and features. It is a fork of weihouya's Dolphin MMJ build (https://github.com/weihuoya/dolphin).
